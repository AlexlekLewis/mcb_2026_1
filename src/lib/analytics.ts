 ...
 *   quote_step_1_complete  Section 1 satisfied (suburb + product). payload: quote tracking context
 *   quote_step_2_complete  Section 2 satisfied (name + phone + email). payload: quote tracking context
 ...
 *   quote_error            submission attempt hit an API/network error (non-2xx or throw)
