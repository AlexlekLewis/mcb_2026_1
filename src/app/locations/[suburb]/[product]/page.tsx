...
export default async function LocationProductPage({ params }: Props) {
  ...
  return (
    <main className="bg-white pt-16">
      ...
      <section className="border-b border-stone-100 bg-mcb-paper px-4 py-8 md:py-10">
      ...
      <section className="bg-mcb-paper px-4 py-8 md:py-10">
      ...
      <section className="bg-mcb-charcoal px-4 py-10 text-center text-white">
