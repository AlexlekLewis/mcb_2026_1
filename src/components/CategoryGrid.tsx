...
const CATEGORIES = [
    ...
    { title: "Plantation Shutters", image: "/images/product-unique/mcb-shutters-category-hero.webp", href: "/shutters", size: "small" },
    { title: "Roller Shutters", image: "/assets/roller_shutters_homepage.png", href: "/shutters/roller-shutters", size: "small" },
    { title: "Security Doors and Fly Screens", image: "/images/product-unique/mcb-security-products-category-hero.webp", href: "/security", size: "small" },
    { title: "Outdoor", image: "/images/product-unique/mcb-outdoor-products-category-hero.webp", href: "/awnings", size: "small" },
];
